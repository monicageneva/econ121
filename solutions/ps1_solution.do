...
//Drop observations with <50 weeks or <35 hours or missing hour or zero earnings.
drop if uhrsworkt<35|wkswork1<50|uhrsworkt>900|incwage==0
...
keep if hours07>=35*50 & hours07<. & laborinc07 >0 & laborinc07<.
...
//similar using OLS (0.115) and WLS (0.115). Since the 
